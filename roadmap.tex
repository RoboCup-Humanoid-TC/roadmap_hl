...
The simple color segmentation and blob detection approaches that were quite popular in the past have become unsuitable, and many teams are using deep learning approaches now \cite{}. 
