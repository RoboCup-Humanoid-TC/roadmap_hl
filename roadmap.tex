...
% - From workshop: at least 3 teams from the semi-final games
...
\item[Kicking motions:]
  \begin{description}
  \item[Kick type:] Forward, side, heel, rolling ball, flying ball, bicycle, throw-in
  \item[Kick power:]
  \item[Kick accuracy:]
  \item[Execution-time:] (inline-kick)
  \item[Shots on goal:]
  \end{description}
\item[Diving saves:] Number of events
\end{description}
...
\item[Self Localization:]
\item[Opponent localization:]
\end{description}

\subsubsection{Gameplay metrics}

\begin{description}
\item[Don't Mess Up Period:]
\item[Players on field:]
\end{description}

\subsection{Detailed rule changes}
% TODO: base elements on metrics
